#图片隐写技术就是把一些文字信息写入到一张图片里,通过解码获得照片里隐藏的文字信息,总而言之,是利用了png图片四个颜色分量(rgba)的最低有效位(英语:Least Significant Bit,lsb)来隐藏文字信息
...
def decodeImage(image):
    ...
    return data
import os
os.chdir(r'C:\Users\EDU\Pictures\Saved Pictures')
encodeDataInImage(Image.open("image001.png"), '你好世界，Hello world!').save('encodeImage.png')
